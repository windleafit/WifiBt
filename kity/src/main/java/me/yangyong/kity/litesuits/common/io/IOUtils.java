 ...
 */
package me.yangyong.kity.litesuits.common.io;

import android.os.Build;
import me.yangyong.kity.litesuits.common.io.stream.*;
...
public class IOUtils {
    ...
    public static InputStream toBufferedInputStream(InputStream input) throws IOException {
        return me.yangyong.kity.litesuits.common.io.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    ...
    public static byte[] toByteArray(InputStream input) throws IOException {
        me.yangyong.kity.litesuits.common.io.stream.ByteArrayOutputStream output = new me.yangyong.kity.litesuits.common.io.stream.ByteArrayOutputStream();
        copy(input, output);
